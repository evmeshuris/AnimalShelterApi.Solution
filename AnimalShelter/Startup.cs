...
//{
//    services.AddMvc();
//    services.AddDbContext<AnimalShelterContext>(
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AnimalShelterContext>(opt =>
                opt.UseMySql(Configuration["ConnectionStrings:DefaultConnection"], new MySqlServerVersion(ServerVersion.AutoDetect(Configuration["ConnectionStrings:DefaultConnection"]))));
