...
var titleBase = "Animal API";

builder.Services.AddControllers(options =>
{
    options.Conventions.Add(new AnimalShelter.Conventions.GroupingByNamespaceConvention());
});
builder.Services.AddEndpointsApiExplorer();
builder.Services.AddSwaggerGen(config =>
{
    var description = "This is a Web API for Animal Shelter operations.";
...
builder.Services.AddDbContext<AnimalShelter.shelterContext>();
